 ...
 * @method \App\Model\Entity\Example|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\Example|bool saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
